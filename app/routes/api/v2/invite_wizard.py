...
def _get_discord_invite_redirect_uri() -> str:
    return (
        ...
        or url_for('api_v2.discord_oauth_callback_public_v2', _external=True)
    )
...
def start_plex_auth_v2(path: InvitePath):
    ...
    try:
        ...
        callback_url = url_for('api_v2.plex_oauth_callback_v2', token=token, _external=True)
...
@api_v2.post(
    "/invite/<token>/server/<int:server_id>/credentials",
    tags=[public_wizard_tag],
