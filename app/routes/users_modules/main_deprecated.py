"""DEPRECATED: Legacy SSR users module main routes (replaced by React SPA)."""
...
from app.routes.user_modules.helpers_deprecated import get_libraries_from_database, _get_local_user_avatar_url
