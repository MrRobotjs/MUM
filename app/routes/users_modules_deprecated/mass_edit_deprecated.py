"""DEPRECATED: Legacy SSR users module mass-edit routes (replaced by React SPA)."""
...
def mass_edit_users():
    ...
    from app.routes.user_modules.helpers_deprecated import get_libraries_from_database
