...
// Plex SVG Icon (large - for plugin cards)
const plexIcon = (
...
// Plex SVG Icon (small - for libraries page)
const plexIconSmall = (
  <svg className="w-5 h-5 stroke-transparent text-plex" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    <path d="M22 25.5h48L116 94l-46 68.5H22L68.5 94Zm109.8 56L108 46l14-20.5h48zm-.3 23.5c10.979 17.625 25.52 38.875 38.5 49.5-11.149 13.635-34.323 32.278-62.5-14z" />
  </svg>
)
...
export const SERVICE_META: Record<string, ServiceMeta> = {
  plex: {
    ...
    label: 'Plex',
    gradient: 'from-plex-400 to-plex-600',
    badgeClass: 'bg-plex-100 text-plex-800',
  ...
  jellyfin: {
    ...
    label: 'Jellyfin',
    gradient: 'from-jellyfin-400 to-jellyfin-600',
    badgeClass: 'bg-jellyfin-100 text-jellyfin-800',
  ...
  emby: {
    ...
    label: 'Emby',
    gradient: 'from-emby-400 to-emby-600',
    badgeClass: 'bg-emby-100 text-emby-800',
  ...
  kavita: {
    ...
    label: 'Kavita',
    gradient: 'from-kavita-400 to-kavita-600',
    badgeClass: 'bg-kavita-100 text-kavita-800',
  ...
  audiobookshelf: {
    ...
    gradient: 'from-audiobookshelf-400 to-audiobookshelf-600',
    badgeClass: 'bg-audiobookshelf-100 text-audiobookshelf-800',
  ...
  komga: {
    ...
    label: 'Komga',
    gradient: 'from-komga-400 to-komga-600',
    badgeClass: 'bg-komga-100 text-komga-800',
  ...
  romm: {
    ...
    label: 'RomM',
    gradient: 'from-romm-400 to-romm-600',
    badgeClass: 'bg-romm-100 text-romm-800',
...
/**
 * Get the library icon for a specific service (smaller, for library page)
 */
export const getServiceLibraryIcon = (pluginId?: string): ReactElement => {
  const meta = getServiceMeta(pluginId)
  return meta.libraryIcon || meta.icon
}
