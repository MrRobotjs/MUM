...
Revision ID: 6b59fc2adbc1
Revises: 
Create Date: 2025-10-03 00:37:54.530890
...
def upgrade():
    ...
    sa.Column('userType', sa.Enum('OWNER', 'LOCAL', 'SERVICE', name='usertype'), nullable=False),
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_users_discord_user_id'), ['discord_user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_email'), ['email'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_external_user_id'), ['external_user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_linkedUserId'), ['linkedUserId'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_localUsername'), ['localUsername'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_overseerr_user_id'), ['overseerr_user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_server_id'), ['server_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_users_service_join_date'), ['service_join_date'], unique=False)
    ...
    with op.batch_alter_table('invite_usages', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_invite_usages_userId'), ['userId'], unique=False)
    ...
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_media_stream_history_user_uuid'), ['user_uuid'], unique=False)
    ...
    sa.Column('user_id', sa.String(length=36), nullable=False),
    sa.Column('visual_role_id', sa.String(length=36), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.uuid'], ondelete='CASCADE'),
...
def downgrade():
    ...
    with op.batch_alter_table('media_stream_history', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_media_stream_history_user_uuid'))
    ...
    with op.batch_alter_table('invite_usages', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_invite_usages_userId'))
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_users_used_invite_id'))
        batch_op.drop_index(batch_op.f('ix_users_service_join_date'))
        batch_op.drop_index(batch_op.f('ix_users_server_id'))
        batch_op.drop_index(batch_op.f('ix_users_overseerr_user_id'))
        batch_op.drop_index(batch_op.f('ix_users_localUsername'))
        batch_op.drop_index(batch_op.f('ix_users_linkedUserId'))
